...
The template can be downloaded from github at [app-lib-py](https://github.com/RachelAlcraft/app-lib-py).
Once using the template and giving your own name and repo, you will need to make some changes to the files.
...
See [dev environments](https://github.com/RachelAlcraft/app-lib-py/blob/main/dev.md)
...
## 6. Implement
The src/app_lib_py directory is the place to write the functional code for the library.
This will become available on pypi as a `pip install`.
